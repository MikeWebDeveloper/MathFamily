...
export function VerifiedStamp({
  ...
  return (
    <details className="relative inline-block align-middle">
      <summary className="inline-flex cursor-pointer list-none items-center gap-1 rounded-full bg-green-100 px-2 py-0.5 text-xs font-semibold text-positive ring-1 ring-positive/20 transition-colors hover:bg-positive/10 dark:bg-positive/15 dark:ring-positive/30 [&::-webkit-details-marker]:hidden">
