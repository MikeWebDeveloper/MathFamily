  ...
  if (variant === "secondary") {
    return (
      <a
        href={href}
        {...(download ? { download: "" } : {})}
        className="mf-edge mf-sheen mf-press group flex items-center gap-2.5 rounded-card bg-card p-4 text-sm outline-none transition-all duration-200 hover:-translate-y-0.5 focus-visible:ring-2 focus-visible:ring-brand-accent"
