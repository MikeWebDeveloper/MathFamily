...
const BRAND = "BuildMath";
const MAX_BODY = 4_000;

/** Email-list signup funnel for the shared cross-brand family group. Accepts JSON (the enhanced
 *  fetch path) and application/x-www-form-urlencoded (the no-JS <form> fallback). Durable-first:
 *  a valid, consented signup is persisted before MailerLite is ever attempted. */
