  ...
  return (
    <section className="space-y-6 py-8">
      ...
      <ul className="flex flex-wrap gap-x-5 gap-y-2 text-sm font-medium">
        <li><Link href="/cost" className="text-brand-accent underline underline-offset-4">Project costs →</Link></li>
        <li><Link href="/regions" className="text-brand-accent underline underline-offset-4">Costs by region →</Link></li>
