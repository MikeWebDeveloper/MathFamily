...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/drop-off-charges/price-index`, changeFrequency: "weekly" as const, priority: 0.9, lastModified: latestModified },
    { url: `${base}/press`, changeFrequency: "weekly" as const, priority: 0.7, lastModified: latestModified },
