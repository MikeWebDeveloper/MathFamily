  ...
  return (
    <section className="space-y-6 py-8">
      ...
      <ul className="flex flex-wrap gap-x-5 gap-y-2 text-sm font-medium">
        <li><Link href="/provider" className="text-brand-accent underline underline-offset-4">By provider →</Link></li>
        <li><Link href="/speed" className="text-brand-accent underline underline-offset-4">By speed →</Link></li>
